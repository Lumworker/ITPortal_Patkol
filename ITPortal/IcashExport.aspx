<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IcashExport.aspx.cs" Inherits="ITPortal.IcashExport" %>
    ...
    <div class="page-header">
        ...
        <div class="row" style="margin-top:3rem">
            <div class="col-md-4 col-sm-4 col-xs-12">
                <h2 style="text-align: left;">ICash Export</h2>
            </div>
        ...
        <%--<button type="button" id="testtest">Call store</button>--%>
        <div class="container">
            <div class="col-md-12">
                <div class="row">
                    <div id="smartwizard">
                        <ul>
                            <li class="check" data-step="Step1"><a href="#step-1">Load Call Plan</a></li>
                                ...
                                <div class="panel-body">
                                    <div style="text-align: center">
                                        <div>
                                            ...
                                            <asp:Button runat="server" ID="Dowloadtext" class="btn btn-warning" OnClick="SFiCsh_Export" Text="Download" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#nextStep2", function () {
                var excel = $("#input-file-now2")[0].files[0];
                ...
                if (excel = '') {
                    ...
                    excel = $("#input-file-now2")[0].files[0];
                    LoadFile(excel, "actual");
                }
            ...
            $(document).on("change", "#input-file-now2", function () {
                var file = $("#input-file-now2").val();
                if (file != "") {
            ...
            $("#download").on("click", function () {
                ...
                $.ajax({
                    type: 'post',
                    url: 'IcashExport.aspx/PK_SFiCsh_Notepad',
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ site_ref: siteRef }),
                    success: function (response) {
                        alert("create Txt file");
                    }
                });
            });

            $("#download_TG").on("click", function () {
                var siteRef = $("#siteRef").val();
                $.ajax({
                    type: 'post',
                    url: 'IcashExport.aspx/TG_SFiCsh_Notepad',
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ site_ref: siteRef }),
                ...
                success: function (status) {
                    if (type == "actual") {
                        if (siteRef == "ERP_PK") {
                            $.ajax({
                                type: 'post',
                                url: 'Default.aspx/SP_Salesforce_ImportIcash',
                                async: false,
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: JSON.stringify({ site_ref: siteRef }),
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    //$.ajax({
                                    //    type: 'post',
                                    //    url: 'IcashExport.aspx/HA_SFiCsh_Notepad',
                                    //    async: false,
                                    //    contentType: "application/json; charset=utf-8",
                                    //    dataType: "json",
                                    //    data: JSON.stringify({ site_ref: siteRef }),
                                    ...
                                    //        $.ajax({
                                    //            type: 'post',
                                    //            url: 'Default.aspx/SP_Salesforce_BackUpIcash',
                                    //            async: false,
                                    //            contentType: "application/json; charset=utf-8",
                                    //            dataType: "json",
                                    //            data: JSON.stringify({ site_ref: siteRef })
