...
{
    /// <summary>
    /// Summary description for UpLoadFileITTAG
    /// </summary>
    public class UpLoadFileITTAG : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string filePath = Path.GetFullPath(Path.Combine(webRootPath, "../ITTAG_Attach/" + context.Request.Form["folderName"]));
